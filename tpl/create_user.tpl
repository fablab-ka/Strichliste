...
<form action="/new_user" method="post">
    ...
    <td><input type="text" style="width:300px;height:50px" name="name" id="name" required><br>
    <label for="email">Email</label>
    <td><input type="email" id="email" id="email" style="width:300px;height:50px" required><br>
    <label for="PIN">PIN (optional)</label>
    <td><input type="password" patter="(0-9){4,}"id="pin" name="pin" title="PIN" style="width:300px;height:50px"><br>
    <label for="name">RFID (optional)</label>
    <td><input type="text" id="barcode" name="rfid" style="width:300px;height:50px"><br>
